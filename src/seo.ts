...
const seoRoutes: Record<Language, Record<string, SeoRouteConfig>> = {
  en: {
    "/": {
      path: "/",
      pageName: "Home",
  ...
  cs: {
    "/": {
      ...
      description:
        "NOXIS je vícevrstvá zpravodajská platforma, která propojuje obranu informačního prostoru, práci s živými kamerami a dronové ISR pod dohledatelnou správou.",
      keywords:
        "noxis, zpravodajská platforma, obrana proti dezinformacím, dohledový software, analýza kamer v reálném čase, drony ISR",
    },
    "/platform": {
      path: "/platform",
      pageName: "Platforma",
      ...
      description:
        "Prozkoumejte architekturu NOXIS: narativní inteligence, fúze kamerových streamů, dronové ISR workflow a auditovatelné rozhodovací stopy.",
      keywords:
        "platforma noxis, vícevrstvá inteligence, kamerová fúze, narativní riziko, dronové ISR, provozní audit",
    },
    "/solutions": {
      path: "/solutions",
      pageName: "Řešení",
      title: "Řešení | NOXIS",
      description:
        "NOXIS nabízí scénářově řízená řešení pro státní správu, kritickou infrastrukturu a bezpečnostní týmy řešící informační i fyzické hrozby.",
      keywords:
        "bezpečnostní řešení, dohledové řešení, use case zpravodajství, ochrana kritické infrastruktury",
    },
    "/company": {
      path: "/company",
      pageName: "Společnost",
      ...
      description:
        "Seznamte se s governance-first přístupem NOXIS, vedením týmu, aliančním rámcem a standardy institucionálního nasazení.",
      keywords:
        "společnost noxis, governance-first bezpečnost, institucionální technologie, audit a dohled",
    },
    "/pricing": {
      path: "/pricing",
      pageName: "Ceník",
      title: "Ceník | NOXIS",
      description:
        "Vyžádejte si cenový návrh NOXIS pro Tier A, Tier B a Tier C podle rozsahu provozu, integračních nároků a požadavků dohledu.",
      keywords:
        "ceník noxis, cena dohledové platformy, cena zpravodajského software, tier nasazení",
    },
    "/lab": {
      path: "/lab",
      pageName: "LAB",
      title: "LAB | NOXIS",
      description:
        "Čtěte výstupy NOXIS LAB: analytické poznámky, benchmark reporty a provozní výzkum v narativní, kamerové a dronové doméně.",
      keywords:
        "noxis lab, zpravodajské reporty, výzkum dezinformací, benchmark kamerových systémů, analýza dronového ISR",
    },
  },
};
...
function buildBreadcrumb(pathname: string, pageName: string, canonicalUrl: string, language: Language) {
...
export function applyRouteSeo(pathname: string, language: Language) {
