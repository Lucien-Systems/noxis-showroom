        ...
        tiers: [
            {
                ...
                description: "Tracks coordinated influence operations, hostile narratives, and manipulation spikes across open, licensed, and mandated information streams.",
                capabilities: [
            ...
            },
            {
                ...
                description: "Combines fixed CCTV, mobile camera feeds, and edge sensors into one command pipeline for rapid incident response and operational continuity.",
                capabilities: [
            ...
            },
            {
                ...
                description: "Integrates UAV telemetry, aerial imagery, and mission channels for dynamic area monitoring under tiered government oversight.",
                capabilities: [
        ...
        useCases: [
            {
                ...
                detail: "Detects coordinated disinformation spikes, synthetic media clusters, and influence channels before they destabilize public decision cycles.",
            },
            {
                title: "Urban camera command and incident response",
                detail: "Correlates realtime camera signals across city, transport, and emergency nodes for faster intervention decisions.",
            },
            {
                title: "Border and perimeter drone oversight",
                detail: "Monitors geospatial corridors with mission telemetry and synchronized escalation into command governance channels.",
            },
            {
                title: "Critical infrastructure continuity",
                detail: "Maps cascading risks across facilities, media narratives, and field sensors to protect operations under stress.",
            },
        ],
        industries: [
            "National Security",
        ...
        labReports: [
            {
                ...
                excerpt: "How cross-platform campaign cells moved from social clusters to mainstream discourse in under 48 hours.",
            },
            {
                title: "Realtime Vision Latency Benchmarks for Tier B",
                category: "Vision Operations",
                excerpt: "Operational benchmark report for high-load camera pipelines and response-window reliability.",
            },
            {
                title: "Aerial ISR Relay Patterns in Dense Urban Zones",
                category: "Drone Operations",
                excerpt: "Mission continuity analysis for UAV handoff, geofence enforcement, and command reconciliation.",
            },
            {
                title: "Oversight by Design: Auditability as a Security Primitive",
                category: "Governance",
                excerpt: "Why cryptographic traceability must be treated as a core command capability, not a compliance add-on.",
            },
        ],
    },
    cs: {
        tiers: [
            {
                ...
                description: "Sleduje koordinované vlivové operace, nepřátelské narativy a manipulační špičky nad otevřenými, licencovanými i mandatovanými datovými zdroji.",
                capabilities: [
            ...
            },
            {
                ...
                description: "Propojuje fixní CCTV, mobilní kamerové streamy a edge senzory do jednoho velitelského toku pro rychlou reakci a provozní kontinuitu.",
                capabilities: [
            ...
            },
            {
                ...
                description: "Integruje telemetrii UAV, letecká data a mission kanály pro dynamické monitorování území pod víceúrovňovým státním dohledem.",
                capabilities: [
        ...
        useCases: [
            {
                ...
                detail: "Odhaluje koordinované dezinformační vlny, syntetický obsah i vlivové kanály dříve, než rozkolísají rozhodovací procesy institucí.",
            },
            {
                title: "Městské kamerové velení a incident response",
                detail: "Koreluje živé kamerové signály napříč městem, dopravou a složkami IZS pro rychlejší operační rozhodnutí.",
            },
            {
                title: "Perimetr a hraniční dohled pomocí dronů",
                detail: "Monitoruje geospatial koridory přes telemetrii misí a navázanou eskalaci do velitelských governance kanálů.",
            },
            {
                title: "Kontinuita kritické infrastruktury",
                detail: "Mapuje kaskádová rizika napříč provozem, mediálním tlakem a terénními senzory, aby chránil provoz pod zátěží.",
            },
        ],
        industries: [
            "Národní bezpečnost",
        ...
        labReports: [
            {
                ...
                excerpt: "Jak se koordinační buňky přesouvaly ze sociálních clusterů do mainstreamové debaty během méně než 48 hodin.",
            },
            {
            ...
            },
            {
                ...
                category: "Governance",
                excerpt: "Proč má být kryptografická dohledatelnost považována za základní schopnost velitelského systému, ne jen compliance doplněk.",
            },
        ],
    },
};
