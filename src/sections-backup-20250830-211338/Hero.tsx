  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 items-end">
      <div>
        ...
        >
          <a className="btn-primary" href="#press">Press &amp; Media</a>
      ...
      <motion.div
        className="h-[280px] md:h-[320px] rounded-2xl border border-line shadow-glow relative overflow-hidden"
        onMouseMove={(e)=>{
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(1100px_380px_at_-200px_-200px,#223355_10%,#1a2744_40%,#0d162c_70%)]" />
